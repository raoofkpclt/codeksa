  ...
  font-family: 'Space Grotesk', sans-serif;
   ...
   hover:text-[#8a6dff]
    ...
    hover:drop-shadow-[0_0_24px_rgba(167,139,250,0.45)]">purpose.</span>
        ...
        <div className="grid md:grid-cols-[280px_1fr] gap-10 md:gap-24">
          ...
          <div className="max-w-3xl space-y-10">
            ...
            <p className="text-white/50 text-lg leading-relaxed">
              CODE brings digital touchpoints together around a clearer customer
              journey and measurable commercial purpose.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-[280px_1fr] gap-10 md:gap-24">
          ...
          <p className="max-w-3xl text-2xl md:text-3xl leading-snug text-white/70">
            ...
            <span className="text-white font-medium">
              where experience, discovery and measurement work together to move
              customers with intent rather than compete for their attention in
              isolation.
            </span>
          </p>
        </div>
      ...
      {/* Capabilities */}
      <section className="max-w-[1600px] mx-auto px-6 md:px-16 py-28 border-t border-white/10">
        <div className="grid min-h-[380px] md:grid-cols-[280px_1fr] gap-10 md:gap-16">
          {/* Left */}
   ...
   hover:text-[#8a6dff]
    ...
    hover:drop-shadow-[0_0_24px_rgba(167,139,250,0.45)]">this pathway connects.</span>
      ...
      {/* Connected Outcomes */}
      <section className="max-w-[1600px] mx-auto px-6 md:px-16 py-28 border-t border-white/10">
        <div className="grid md:grid-cols-[320px_1fr] gap-12 md:gap-24">
          {/* Left */}
          <div>
            <div className="text-xs tracking-[0.2em] text-white/40 uppercase mb-6">
              Connected Outcomes
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-[700px] border-t border-white/10">
              {outcomes.map((outcome) => (
                ...
                >
                  <span className="w-8 shrink-0 font-['Space_Grotesk',sans-serif] text-sm tracking-[0.2em] text-white/40">
                    {outcome.number}
                  </span>

                  <span className="font-['Space_Grotesk',sans-serif] text-[28px] md:text-[42px] font-light leading-[1.1] text-white/80">
                    {outcome.title}
                  </span>
                </div>
              ))}
      ...
      <section className="max-w-[1600px] mx-auto px-6 md:px-16 py-28 border-t border-white/10">
        <div className="grid md:grid-cols-[280px_1fr] gap-10 md:gap-16">
          <div>
            ...
            <h2 className="max-w-[900px] font-['Space_Grotesk',sans-serif] text-[clamp(50px,2vw,130px)] font-light leading-[0.9] tracking-[-0.06em] text-[var(--code-white)]">
   ...
   hover:text-[#8a6dff]
    ...
    hover:drop-shadow-[0_0_24px_rgba(167,139,250,0.45)]">applies.</span>
          ...
          <div className="flex flex-wrap gap-x-12 gap-y-6 content-start">
            {industries.map((industry) => (
              <span
                key={industry}
                className="text-xl md:text-2xl font-light text-white/60 hover:text-white transition-colors cursor-default"
              >
                {industry}
              </span>
            ))}
      ...
      <section className="max-w-[1600px] mx-auto px-6 md:px-16 pt-28 pb-32 md:pb-48 border-t border-white/10">
   ...
   hover:text-[#8a6dff]
    ...
    hover:drop-shadow-[0_0_24px_rgba(167,139,250,0.45)]">Same system.</span>
        ...
        <div className="border-t mt-34 border-white/10">
      ...
      <section className="max-w-[1600px] mx-auto px-6 md:px-16 py-32 border-t border-white/10">
        <h2 className="max-w-[1100px] font-['Space_Grotesk',sans-serif] text-[clamp(72px,10vw,130px)] font-light leading-[0.9] tracking-[-0.06em] text-[var(--code-white)]">
  <span className="font-light">
    Connect digital{" "}
  </span>
   ...
   hover:text-[#8a6dff]
    ...
    hover:drop-shadow-[0_0_24px_rgba(167,139,250,0.45)]">take.</span>
        ...
        <p className="mt-10 max-w-xl text-white/50 text-lg leading-relaxed">
          Experience, discovery and measurement designed to work together, not
