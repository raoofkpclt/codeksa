...
const WorkManagement = () => {
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      await WorkService.updateStatus(
        work.id,
        status
      );
