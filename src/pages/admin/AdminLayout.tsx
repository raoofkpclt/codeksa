...
<div
  className={`border-t border-white/[0.08] py-6 ${
    collapsed ? "flex flex-col items-center px-0" : "px-6"
  }`}
>
  {!collapsed && (
    <>
  ...
  <button
    ...
    className={`group relative flex items-center justify-center gap-2 border border-white/10 bg-white/[0.03] text-[11px] font-medium uppercase tracking-[0.1em] text-white/70 transition-colors hover:border-red-500/30 hover:bg-red-500/10 hover:text-red-400 ${
      collapsed ? "mt-0 h-9 w-9 px-0" : "mt-4 w-full px-3.5 py-2.5"
    }`}
  >
    <svg
      width="14"
