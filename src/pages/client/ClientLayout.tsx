  ...
  return (
    <div className="flex min-h-screen bg-black text-white font-['Space_Grotesk',sans-serif]">
      ...
      >
        ...
        <div
          className={`border-t border-white/[0.08] px-6 py-6 ${
            collapsed ? "md:hidden" : ""
          }`}
        >
          ...
          <p className="mt-2 text-[13px] font-medium text-white/90 truncate">
            {clientName}
          </p>
        ...
        <div
          className={`hidden flex-col items-center gap-4 border-t border-white/[0.08] py-6 ${
            collapsed ? "md:flex" : ""
          }`}
        >
          <div
      ...
      <div className="relative z-10 flex flex-1 min-w-0 flex-col">
        ...
        <div className="flex items-center gap-4 border-b border-white/[0.08] bg-black px-4 py-4 md:hidden">
          <button
